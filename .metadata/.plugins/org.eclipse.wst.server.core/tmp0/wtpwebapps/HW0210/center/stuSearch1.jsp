...
<html>
  <head>
    ...
    <script type="text/javascript">
    	function stuSearch1Func(pageName) {
    		var ff = document.stuSearch1Form;
  ...
  <body>
	...
	%>
	<form name="stuSearch1Form">
	<fieldset style="width: 400px;">
	<legend style="font-size: 50px;">학생 이름 검색</legend>	
		<p>성적 입력할 학생의 이름을 입력하세요.</p>
		<p>
			<input type="text" name="sname">
			<input type="image" src="/HW0210/imges/ss1.png" onclick="">
<!-- 					onclick="stuSearch1Func('stuSearch2')"> -->
		</p>
	</fieldset>
	</form>
	<%
