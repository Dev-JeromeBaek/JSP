...
<form style="width: 1150px" action="/Curr01_Basic/ex/ex007_Join02.jsp" 
		method="post" onsubmit="return tocheckpw1()">
	<fieldset>
	<legend style="font-size:80px">Join</legend>
		<table border="0" style="margin-left:180px; 
			...
			<tr>
				<td class="YY">&nbsp; 아이디</td>
				<td class="ZZ=">&nbsp;
					<input type="text" style="width: 298px" name="id" 
			...
			<tr>
				...
				<td class="ZZ">&nbsp; 
					<input type="password" id="pw" name="pw" 
						style="width: 300px" placeholder="비밀번호 입력"></td>
			</tr>
			<tr>
				<td class="YY">&nbsp; 비밀번호 확인</td>
				<td class="ZZ">&nbsp; 
					<input type="password" id="pw_Check" 
						name="pw_Check" style="width: 300px" 
			...
			<tr>
				...
				<td class="ZZ">&nbsp; 
					<input type="text" style="width: 300px" 
						name="name" placeholder="한글로입력하세요"></td>
			...
			<tr>
				...
				<td class="ZZ">
					...
					- <input name="tel02" type="number" 
							style="width: 88px" maxlength="4"/> 
					- <input name="tel03" type="number" 
							style="width: 88px" maxlength="4"/></td>
			...
			<tr>
				...
				<td class="ZZ">
					...
					- <input name="phone02" type="number" 
							style="width: 88px" maxlength="4"/>
					- <input name="phone03" type="number" 
							style="width: 88px" maxlength="4"/> 
				</td>
			</tr>
			<tr>
				...
				<td class="ZZ">
					&nbsp;
					<input type="text" style="width: 125px" name="email01">
					 @
					<input id="email02" type="text"
						style="width: 130px;" name="email02">
			...
			<tr>
				...
				<td style="width: 460px; height: 50px;">&nbsp;&nbsp;&nbsp;
					...
					<input name="interest" 
						type="checkbox" value="JSP"> JSP&nbsp;&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="Spring"> Spring&nbsp;&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="R"> R&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="HADOOP"> HADOOP&nbsp; 
					<br>&nbsp;&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="HTML"> HTML&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="CSS"> CSS&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="JQuery"> JQuery&nbsp;&nbsp;&nbsp;
					<input name="interest" 
						type="checkbox" value="Data Base"> Data Base<br>
				</td>
			</tr>
			<tr>
				...
				<td style="width: 460px; height: 166px;">&nbsp;&nbsp;
					<textarea rows="5" cols="45" 
						name="memo" style="width: 425px; height: 160px"></textarea>
				</td>
